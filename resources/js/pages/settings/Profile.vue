        ...
        <SettingsLayout>
            <div class="flex flex-col space-y-6">
                ...
                <div class="rounded-xl border border-sidebar-border/70 p-6 dark:border-sidebar-border">
                    ...
                    <!-- Status messages -->
                    <div v-if="status === 'avatar-updated'" class="mt-4 p-3 bg-green-100 border border-green-400 text-green-700 rounded">
                        Avatar atualizado com sucesso!
                    </div>
                    <div v-if="status === 'avatar-deleted'" class="mt-4 p-3 bg-blue-100 border border-blue-400 text-blue-700 rounded">
